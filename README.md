...
![Training Progression at 100 Epochs](outputs/generated_plot_e100_acc_real_0.00%_acc_fake_0.00%.png)

### Discriminator and Generator Loss

The following plot shows the loss curves for both the Discriminator and the Generator during training:

![Loss Curves](images/loss_curves.png)

### Visual Inspection

The following plots shows the progression of generated images over training epochs, providing a visual inspection of the model's learning process through 3 different stages of training:

```markdown
![Training Progression at 10 Epochs](outputs/generated_plot_e010_acc_real_0.00%_acc_fake_0.00%.png)
![Training Progression at 50 Epochs](outputs/generated_plot_e050_acc_real_0.00%_acc_fake_0.00%.png)
![Training Progression at 100 Epochs](outputs/generated_plot_e100_acc_real_0.00%_acc_fake_0.00%.png)
```

These results demonstrate the effectiveness of the cGAN model in generating realistic MNIST digit images conditioned on class labels. The quantitative metrics and visual inspections provide a comprehensive evaluation of the model's performance.
